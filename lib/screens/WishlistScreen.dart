...
class WishlistScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> products = const [
    ...
    {
      "title": "Immunity Booster Capsules",
      "image": "https://cdn.pixabay.com/photo/2017/07/26/22/09/licorice-2543337_640.jpg",
      "oldPrice": "₹700.00",
      "price": "₹499.00",
    },
    {
      "title": "Digestion Care Powder",
      "image": "https://cdn.pixabay.com/photo/2016/04/01/10/06/bay-1299772_640.png",
      "oldPrice": "₹450.00",
      "price": "₹300.00",
    },
    {
    ...
    {
      "title": "Joint & Muscle Care Balm",
      "image": "https://cdn.pixabay.com/photo/2021/02/18/04/03/marijuana-6026030_640.jpg",
      "oldPrice": "₹600.00",
      "price": "₹450.00",
    },
    {
          ...
          body: Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildWishlistCard(context, screenWidth, product);
              },
            ),
          ),
        );
        ...
        children: [
          IconButton(
            icon: Icon(
              Icons.close,
              color: Colors.black,
              size: MediaQuery.of(context).size.width * 0.06, // dynamic size
            ),
            onPressed: () {
...
// closes current screen and goes back
            },
          ),
  ...
  Widget _buildWishlistCard(BuildContext context, double screenWidth, Map<String, String> product) {
    return Container(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Icon(Icons.favorite, color: Colors.orange, size: screenWidth * 0.045),
                  ),
                ),
              ],
            ),
