...
class ProfileScreen extends StatelessWidget {
  ...
  // 📌 Method to create/open a sample PDF
  Future<void> _openPdf(BuildContext context) async {
    try {
      debugPrint("📂 Opening PDF from assets...");
      ...
      debugPrint("✅ PDF copied to: ${file.path}");

      // Open with default PDF viewer
      final result = await OpenFilex.open(file.path);
      debugPrint("📖 OpenFilex result: ${result.type} - ${result.message}");

      // Refresh the bottom nav bar after returning from PDF viewer
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildListTile(Icons.picture_as_pdf, "Open PDF", () {
                    _openPdf(context);
                  }),
