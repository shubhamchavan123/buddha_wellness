...
class _EditProfileScreenState extends State<EditProfileScreen> {
  bool isPublic = false;
  final TextEditingController _nameController = TextEditingController(text: "Vaishnavi");
  final TextEditingController _lastNameController = TextEditingController(text: "Mangam");
