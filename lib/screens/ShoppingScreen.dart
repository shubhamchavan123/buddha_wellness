import 'package:buddha_wellness/screens/DashboardScreen.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _label("First Name*"),
                _textField(hint: "Vaishnavi"),
      
                _label("Last Name*"),
                _textField(hint: "Mangam"),
                ...
                _label("Company Name*"),
                _textField(hint: "Vaishnavi PVT LTD"),
      
                _label("Enter your GST Number*"),
                _textField(hint: "GST2810"),
                const SizedBox(height: 20),
                const Text(
                  "Residential Details",
                  style: TextStyle(
